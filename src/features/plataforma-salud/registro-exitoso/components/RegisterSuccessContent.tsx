...
const RegisterSuccessContent = () => {
  ...
  useEffect(() => {
    if (!checkAccess()) {
      router.push({ pathname: '/plataforma-salud/registro' });
    }
  }, [checkAccess, router]);
  ...
  const handleGoToLogin = () => {
    ...
    router.replace({ pathname: '/plataforma-salud/login' });
  };
        ...
        <MedicalCard variant="health-platform" className="w-full">
          ...
          <div className="space-y-3">
            <button
              ...
              className="cursor-pointer w-full bg-[var(--color-primary)] text-white py-3 px-4 rounded-lg hover:bg-[#248456] hover:-translate-y-0.5 hover:shadow-sm focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)] disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 font-medium"
            >
            ...
            <button
              ...
              className="cursor-pointer w-full bg-white text-[var(--color-primary)] py-3 px-4 rounded-lg border-2 border-[var(--color-primary)] hover:bg-[var(--color-primary)] hover:text-white hover:-translate-y-0.5 hover:shadow-sm focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)] transition-all duration-200 font-medium"
            >
              {t('go-to-login')}
            </button>
          </div>
