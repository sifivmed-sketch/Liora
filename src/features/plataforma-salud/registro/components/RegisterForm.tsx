...
import { registerPatient, RegisterPatientRequest, isRegistrationSuccessful, getRegistrationErrorMessage } from "../services/register.service";
                ...
                <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
                    <label className="flex items-start space-x-3 cursor-pointer">
                        ...
                        <span className="text-sm text-gray-700 select-none">
                            ...
                            {" "} {t("information-authorization-confirmation")}
                        </span>
                    </label>
                </div>
